...
extern int LLI[RCVN][PRN],LLI2[RCVN][PRN];
...
extern int RTK,Doppler;
extern int Reject_cn[RCVN][PRN];
extern int Loose_flag,Partial_flag;

extern double Elevation_mask1;
extern double Threshold_cn,HDOP,VDOP,PDOP,GDOP,TDOP,Ratio_limit;
extern double Pr1[RCVN][PRN],SPr1[RCVN][PRN],OPr1[RCVN][PRN];//擬似距離
extern double Cp1[RCVN][PRN];//搬送波位相
extern double Cn1[RCVN][PRN],Dp1[RCVN][PRN];
extern double Pr2[RCVN][PRN],Cp2[RCVN][PRN],Dp2[RCVN][PRN],Cn2[RCVN][PRN];
extern double SVx[RCVN][PRN],SVy[RCVN][PRN],SVz[RCVN][PRN];//衛星位置
extern double SVx_next[RCVN][PRN],SVy_next[RCVN][PRN],SVz_next[RCVN][PRN];//衛星位置
extern double SVx_prev[RCVN][PRN],SVy_prev[RCVN][PRN],SVz_prev[RCVN][PRN];//衛星位置
...
extern double OmomiP[PRN],OmomiC[PRN],OmomiPB[PRN],OmomiCB[PRN],OmomiPR[PRN],OmomiCR[PRN],OmomiPRR[PRN],OmomiCRR[PRN];
extern double GF1[PRN],GF2[PRN];
extern double Pr1ref[PRN],Cp1ref[PRN],Pr2ref[PRN],Cp2ref[PRN];
extern double User_lat,User_lon,User_hgt,User_pos[3];
extern double LeapSecond;
extern double Correction[PRN];
extern double Vel[3],Vel_lat,Vel_lon,Vel_hgt,Pre_vel[3];
extern double DGPS_lat,DGPS_lon,DGPS_hgt,Loose_pos[3],Loose_lat,Loose_lon,Loose_hgt;
extern double RTK_lat,RTK_lon,RTK_hgt;
extern double Fix_pos[3],Code_omomi;
