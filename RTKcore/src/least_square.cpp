...
void least_square(int rcvn, double init[4], int iter, int pos)
{
	...
	int stock_sat[PRN] = { 0 };
	static int j = 0, m = 0;
	double r2[PRN], r3[PRN], a[PRN] = { 0.0 }, b[PRN] = { 0.0 }, c[PRN] = { 0.0 }, e[PRN] = { 0.0 }, f[PRN] = { 0.0 }, g[PRN] = { 0.0 }, a2[PRN], a3[PRN*2], a4[PRN],
	...
	if (MinSvNum == 4) {
		...
		Code_omomi = sqrt(xx[0]*xx[0]+xx[5]*xx[5]+xx[10]*xx[10]);
	}//GPS/QZSS
